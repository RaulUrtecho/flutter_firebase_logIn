...
void main() {
  const loginButtonKey = Key(Keys.loginForm_continue_raisedButton);
  const signInWithGoogleButtonKey =
      Key(Keys.loginForm_googleLogin_raisedButton);
  const emailInputKey = Key(Keys.loginForm_emailInput_textField);
  const passwordInputKey = Key(Keys.loginForm_passwordInput_textField);
  const createAccountButtonKey = Key(Keys.loginForm_createAccount_flatButton);
