  ...
  Widget build(BuildContext context) {
    return BlocBuilder<LoginCubit, LoginState>(
      ...
      builder: (context, state) {
        return TextField(
          key: const Key(Keys.loginForm_emailInput_textField),
...
class _GoogleLoginButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return RaisedButton.icon(
      key: const Key(Keys.loginForm_googleLogin_raisedButton),
      label: const Text(
        'SIGN IN WITH GOOGLE',
...
class _SignUpButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    return FlatButton(
      key: const Key(Keys.loginForm_createAccount_flatButton),
      child: Text(
        'CREATE ACCOUNT',
